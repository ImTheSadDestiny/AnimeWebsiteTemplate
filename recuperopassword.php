...
h1 {
    ...
    font-size: 70px;
                        ...
                        <h1 style="color:white; ">Recupera<n style="color:#e53637;"> Password</n></ciao>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="login__form">
                        ...
                        <form id="login" name="login" method="post" action="email.script.php">
                            <div class="input__item">
                                <input type="email" placeholder="Email" name="email" require>
                                <span class="icon_profile"></span>
                            </div>
                            <button type="submit" name="submit" value="Login" class="site-btn">Richiedi Email</button>
                        </form>
                    </div>
                </div>
            </div>
