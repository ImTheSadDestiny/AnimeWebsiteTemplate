...
h1 {
    ...
    font-size: 70px;
                        ...
                        <h1 style="color:white; ">Log<n style="color:#e53637;">in</n></ciao>
                        <p style="color:white;">Benvenuti nel blog<n style="color:#e53637;"> ufficiale di Anime.</n></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="login spad">
        <div class="container">
            ...
            if(isset($_SESSION["id"])){	
			?> <h1 style='color:white;'>Ciao <?php echo $_SESSION["nome"]; ?></h1>
            <form id="login" name="login" method="post" action="logout.script.php">
			<button type="submit" name="submit" value="Login" class="site-btn">Clicca per il logout</button>
            </form>  
           <?php }else{?>
                        <form id="login" name="login" method="post" action="login.script.php">
                            <div class="input__item">
                                <input type="text" placeholder="Nome Utente" name="utente" require>
                            ...
                            <button type="submit" name="submit" value="Login" class="site-btn">Loggati ora</button>
                        </form>
                        <a href="recuperopassword.php" class="forget_pass">  non ricordi la password?</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login__register">
                        <h3>Non hai un'account?</h3>
                        <a href="signup.php" class="primary-btn">Registati ora</a>
                    </div>
                </div>
            </div>
          <?php } 
          			if(isset($_SESSION["errore_login"]) && $_SESSION["errore_login"]==true){
                        echo "<p style='color:white;'>  Nome utente o password errati! Ritenta!</p>";
