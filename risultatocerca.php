            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="product__page__content">
                        ...
                        <?php  $cont=0;
    $query1 = "SELECT * FROM serie WHERE serie.nome LIKE '%".$cercaNome."%' ORDER BY serie.nome ASC";
                                ...
                                <?php  $query18 =" SELECT COUNT(episodi.fkSerie)as episodi FROM serie INNER JOIN episodi on episodi.fkSerie = serie.id WHERE serie.id = ".$qu1["id"]."";
                                        ...
                                        if($risultato18->num_rows > 0){
                                            while($qu18 = $risultato18->fetch_assoc()){
                                                 $query14 =" SELECT serie.numEpisodi as numEp FROM serie WHERE serie.id = ".$qu1["id"]."";
