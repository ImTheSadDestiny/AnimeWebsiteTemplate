...
h1 {
    ...
    font-size: 70px;
                        ...
                        <h1 style="color:white; ">Regis<n style="color:#e53637;">trati</n></ciao>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="login__form">
                        <h3>Registrati</h3>
                        <form id="login" name="login" method="post" action="signup.script.php">
                            ...
                            <div class="input__item">
                                <input type="password" placeholder="Conferma Password" name="pwd2" require>
                                <span class="icon_lock"></span>
                            </div>
                            <button type="submit" name="submit" value="Login" class="site-btn">Registrati!</button>
                        </form>

                        <h5>Hai già un account? <a href="login.php">Loggati ora!</a></h5>
                        <?php if(isset($_SESSION["Erroreusr"])&&$_SESSION["Erroreusr"]==true){ echo" <br><p style='color:white;'>Username o Email già utilizzati riprova cambiandoli</p>"; unset($_SESSION["Erroreusr"]);} ?>
