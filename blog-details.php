        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2">
			        ...
			        ?> 
                    <span><a style='transform: translateX(-600%);'href="#" class="search-switch"><span class="icon_search"></span></a>
                        <a style='transform: translateY(-120%); color:white;'><?php if(isset($_SESSION["id"])){?><a href="./login.php">Ciao <?php echo $_SESSION["nome"]; }?></a></a>
                    </div>
                    <?php }else{?>
